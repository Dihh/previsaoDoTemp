...
export default {
  ...
  methods: {
    async getData() {
      const GOOGLE_API_KEY = this.$store.getters.getGOOGLE_API_KEY;
      const OPENWEATHERMAP_KEY = this.$store.getters.getOPENWEATHERMAP_KEY;

      console.log(OPENWEATHERMAP_KEY);
